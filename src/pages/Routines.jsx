...
export default function Routines() {
  ...
  function handlePickerSelect(ex) {
    const updated = {
      ...
      [activeDay]: {
        ...routines[activeDay],
        exercises: [...(routines[activeDay]?.exercises || []), ex]
      }
    }
    setRoutines(updated)
    save(updated)
  ...
  const dayColors = { 1: 'var(--red)', 2: '#9B59B6', 3: 'var(--blue)', 4: '#F39C12', 5: 'var(--green)' }
  ...
  return (
    <div className="page fade-in">
      ...
      {showPicker && <ExercisePicker onSelect={handlePickerSelect} onClose={() => setShowPicker(false)} defaultSets={4} />}
    </div>
  )
}
